...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 24, 2025 at 06:55 AM
...
CREATE TABLE IF NOT EXISTS `active_service_provider` (
  ...
  `iso_certified` enum('yes','no') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `business_permit` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `company_profile` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `calculated_rates` (
  ...
  `carrier_type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
(52, 63, 31, 'Land', 'per kg', 13.00, 650.00, '2025-09-22 18:11:33', 'Pending');
...
CREATE TABLE IF NOT EXISTS `freight_rates` (
  ...
  `distance_range` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `weight_range` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `network_points` (
  ...
  `point_name` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `point_type` enum('Port','Airport','Warehouse','Terminal') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `schedules` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'scheduled',
  `total_rate` decimal(12,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sop_documents` (
  ...
  `status` enum('Active','Draft','Archived') COLLATE utf8mb4_general_ci DEFAULT 'Draft',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
