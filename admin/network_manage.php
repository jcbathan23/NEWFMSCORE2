...
<div class="content">
  <h3 class="mb-4">NETWORK POINTS</h3>
  ...
  <button type="button" class="btn btn-success mb-2" data-bs-toggle="modal" data-bs-target="#addPointModal">
...
<div class="table-responsive">
  <table class="table table-hover table-striped align-middle text-center">
    ...
    <tbody>
      ...
      ?>
      <tr>
        <td class="fw-bold"><?= $row['point_id'] ?></td>
        <td class="text-start"><?= htmlspecialchars($row['point_name'], ENT_QUOTES) ?></td>
        <td><?= htmlspecialchars($row['point_type'], ENT_QUOTES) ?></td>
        <td><?= htmlspecialchars($row['city'], ENT_QUOTES) ?></td>
        <td class="text-primary"><?= $row['latitude'] ?></td>
        <td class="text-primary"><?= $row['longitude'] ?></td>
        <td>
        ...
        <td>
          <div class="btn-group btn-group-sm" role="group">
            <button type="button" class="btn btn-info viewBtn" data-bs-toggle="modal" data-bs-target="#viewPointModal"
           ...
           <a href="#" class="btn btn-warning editBtn" data-bs-toggle="modal" data-bs-target="#editPointModal"
   data-id="<?= $row['point_id'] ?>"
   data-name="<?= htmlspecialchars($row['point_name'], ENT_QUOTES) ?>"
   data-type="<?= htmlspecialchars($row['point_type'], ENT_QUOTES) ?>"
   data-city="<?= htmlspecialchars($row['city'], ENT_QUOTES) ?>"
